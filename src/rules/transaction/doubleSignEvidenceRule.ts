...
export class DoubleSignEvidence extends TransactionRule {
    ...
    async handle(transaction: IndexedTx, factory: AlertFactory): Promise<void> {
        ...
        console.log("Processing DoubleSignEvidence for tx " + transaction.hash);
    ...
    getRuleDescription(): string {
        // Add more info such as submitter and evidence values
        return 'Double sign evidence submitted';
    }
